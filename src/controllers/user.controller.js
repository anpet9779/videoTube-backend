...
/**
 * Method to get user channel profile
...
/**
 * Method to get user watch history
 * @returns {user}
 * @returns user
 */
const getWatchHistory = asyncHandler(async (req, res) => {
  const user = await User.aggregate([
    {
      $match: {
        _id: new mongoose.Types.ObjectId(req.user?._id), //Cannnot directly give string so need to convert to mongoose id req.user?._id,
      },
    },
    {
      $lookup: {
